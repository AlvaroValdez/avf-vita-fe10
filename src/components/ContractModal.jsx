        ...
        <Modal show={show} onHide={onHide} size="lg" backdrop="static" keyboard={false}>
            ...
            <Modal.Body style={{ maxHeight: '60vh', overflowY: 'auto' }} className="small text-secondary px-4">
                ...
                <p><strong>A) EL MANDANTE (EL USUARIO):</strong> Persona natural o jurídica identificada mediante sus credenciales de acceso y validación KYC en la plataforma.<br />
                    <strong>B) EL MANDATARIO (LA EMPRESA):</strong> <strong>AV FINANCE</strong>, constituida legalmente en el Estado Plurinacional de Bolivia, en proceso de adecuación como Empresa de Tecnología Financiera (ETF) y Proveedor de Servicios de Activos Virtuales (PSAV).</p>

                <hr className="my-3" />

                <h6 className="fw-bold text-dark mt-3">CLÁUSULA PRIMERA: OBJETO (EL SALVAVIDAS LEGAL)</h6>
                <p className="text-justify">EL USUARIO otorga MANDATO DE GESTIÓN a AV FINANCE para que, por su cuenta y orden, realice operaciones de compra, venta, intercambio y transferencia de Activos Virtuales (USDC/USDT/XLM) y moneda fiduciaria (Bolivianos/Dólares), utilizando la infraestructura tecnológica de la Billetera "Alyto". <strong>Los fondos gestionados son propiedad exclusiva de EL USUARIO.</strong></p>

                <h6 className="fw-bold text-dark mt-3">CLÁUSULA SEGUNDA: DECLARACIÓN JURADA DE ORIGEN DE FONDOS (ANTI-UIF)</h6>
