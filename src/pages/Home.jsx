      ...
      >
        ...
        <Container className="py-5 position-relative" style={{ zIndex: 1 }}>
          <Row>
            ...
            {/* El formulario ya NO va aquí */}
          </Row>
        </Container>
      </div>

      {/* --- NUEVA SECCIÓN PARA EL FORMULARIO DE REMESAS --- */}
      <Container className="my-5">
        <Row className="justify-content-center">
            {/* Centramos el formulario en esta nueva sección */}
            <Col lg={6}>
              <RemittanceSteps />
            </Col>
        </Row>
